...
const OldComponent = props => {
  ...
  function sayHello() {
    ...
    const product = {
      ...
      categories: [cat],
      start: {
        dateTime: "2020-03-30T12:00:00",
        timeZone: "Pacific Standard Time"
      },
      end: {
        dateTime: "2020-03-30T14:00:00",
        timeZone: "Pacific Standard Time"
      },
      location: {
  ...
  useEffect(() => {
    ...
    // react_img = imageCode("logo192.png");
    data('logo192.png');
    console.log("Raj Chodu" + image);
    setImage(0);
    data('logo512.png');
    console.log("Raj Lodu " + image);
    // const other_img = imageCode("logo512.png");
    // console.log(other_img);
    // data()
  });
  // console.log(react_img);

  const data = (name) => {
    image2base64(__dirname + name) // you can also to use url
